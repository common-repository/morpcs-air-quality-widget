...
(function ($) {
  ...
  function refreshAQI() {
    ...
    let url = aqiLocalSettings.proxy_uri;
    url += aqiLocalSettings.airnow_uri;
    ...
    $.ajax({
      ...
      dataType: "json",
      headers: {
        "x-cors-grida-api-key": aqiLocalSettings.proxy_key,
      },
    })
  ...
  function parseCompactWidgetResults(results) {
    ...
    if (aqiLocalSettings.show_forecast === "1" && forecast.length > 0) {
      $("#aqi_compact").append(
        "<span title='View Forecast' id='aqi_compact_view_more' class='aqi_theme_" + theme + "'> &#9432;</span>"
      );
  ...
  function parsePageWidgetResults(results) {
    ...
    let aqi = "<br><span class='aqi_theme_" + theme + "'>";
    aqi += "<br>The current Air Quality for " + aqiLocalSettings.zip;
    ...
    if (aqiLocalSettings.show_forecast === "1") {
      ...
      distinctForecastDates.forEach((forecastDate) => {
        ...
        if (duplicates.length > 1) {
          ...
          forecastTable += "<div class='aqi-div-table-row'>";
          forecastTable +=
            "<div class='aqi-div-table-cell aqi_theme_" + theme + "'>" + results[parentIdx].DateForecast + "</div>";
          forecastTable +=
            "<div class='aqi-div-table-cell aqi_theme_" +
            theme +
            "'>" +
            getAQIDisplayVal(results[parentIdx].AQI) +
            "</div>";
          forecastTable +=
            "<div class='aqi-div-table-cell aqi_theme_" + theme + "'>" + results[parentIdx].Category.Name + "</div>";
          forecastTable += "</div>";
        }
      });
      ...
      if (forecastFiltered === false) {
        results.forEach(function (result) {
          ...
          forecastTable +=
            "<div class='aqi-div-table-cell aqi_theme_" + theme + "'>" + getAQIDisplayVal(result.AQI) + "</div>";
  ...
  function maybeShowLegend(theme) {
    ...
    if (aqiLocalSettings.show_legend === "1") {
      ...
      legendTable += "<div class='aqi-div-table-body'>";
      legendTable += "<div class='aqi-div-table-row'>";
      ...
      legendTable += "<div class='aqi-div-table-row'>";
      legendTable +=
        "<div class='aqi-div-table-cell aqi_theme_" + theme + " legend legend-color-yellow'>Moderate</div>";
      ...
      legendTable += "<div class='aqi-div-table-row'>";
      legendTable += "<div class='aqi-div-table-cell aqi_theme_" + theme + " legend legend-color-orange'>";
      legendTable += "<span class='legend-text-white'>Unhealthy for Sensitive Groups</span>";
      legendTable += "</div>";
      ...
      legendTable += "<div class='aqi-div-table-row'>";
      legendTable += "<div class='aqi-div-table-cell aqi_theme_" + theme + " legend legend-color-red'>";
      legendTable += "<span class='legend-text-white'>Unhealthy</span>";
      legendTable += "</div>";
      ...
      legendTable += "<div class='aqi-div-table-row'>";
      legendTable += "<div class='aqi-div-table-cell aqi_theme_" + theme + " legend legend-color-purple'>";
      legendTable += "<span class='legend-text-white'>Very Unhealthy</span>";
      legendTable += "</div>";
      ...
      legendTable += "<div class='aqi-div-table-row'>";
      legendTable += "<div class='aqi-div-table-cell aqi_theme_" + theme + " legend legend-color-purple'>";
      legendTable += "<span class='legend-text-white'>Hazardous</span>";
      legendTable += "</div>";
  ...
  function setUnavailable() {
    ...
    let unavailable = "<div class='aqi-unavailable'>AQI Unavailable. Try refreshing.</div>";

    if ($("#aqi-widget-container-compact").length) {
      $("#aqi-widget-container-compact").append(unavailable);
    }

    if ($("#aqi-widget-container-page").length) {
      $("#aqi-widget-container-page").append(unavailable);
    }
  }
